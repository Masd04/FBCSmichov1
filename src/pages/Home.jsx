...
function Home() {
  return (
	...
	<div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12">
		...
		<a rel="noopener noreferrer" href="/FBCSmichov1/clanek" className="block rounded-3xl max-w-sm gap-3 mx-auto sm:max-w-full group hover:no-underline focus:no-underline lg:grid lg:grid-cols-12 bg-gray-300">
			<img src={florbalisti} alt="" className="object-cover w-full h-64 rounded-l-3xl sm:h-96 lg:col-span-7 dark:bg-gray-500" />
			<div className="p-6 space-y-2 lg:col-span-5">
				<h3 className="text-2xl font-semibold sm:text-4xl group-hover:underline group-focus:underline">Článek o florbalistech</h3>
