...
function Home() {
  return (
	...
	<div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12">
		...
		<a rel="noopener noreferrer" href="#" className="block rounded-3xl max-w-sm gap-3 mx-auto sm:max-w-full group hover:no-underline focus:no-underline lg:grid lg:grid-cols-12 bg-gray-300">
